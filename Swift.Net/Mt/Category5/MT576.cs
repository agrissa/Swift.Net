...
namespace Swift.Net.Mt.Category5
{
    ...
    /// MT576 (SRG 2019)
    /// <summary>
    public partial class MT576 : SwiftMessage
    {
        ...
        /// General Information
        /// <summary>
		public MT576_SequenceA SequenceA { get; set; }
        /// <summary>
        /// Financial Instrument
        /// <summary>
		public List<MT576_SequenceB> SequenceBList { get; set; }
        /// <summary>
        /// Additional Information
        /// <summary>
		public MT576_SequenceC SequenceC { get; set; }

        public MT576()
        {
        }

        public MT576(SwiftTagList tags)
        {
            SetBlock4Tags(tags);
        }
        ...
        {
            SequenceA = MT576_SequenceA.GetMT576_SequenceA(tags);
            SequenceBList = MT576_SequenceB.GetMT576_SequenceBList(tags);
            SequenceC = MT576_SequenceC.GetMT576_SequenceC(tags);
        }

        public static MT576 Parse(string message)
        {
            SwiftMessage swiftMessage = new SwiftParser().GetSwiftMessage(message);
            MT576 result = new MT576()
            {
        ...
        public static string Write(MT576 message)
        {
    ...
    /// General Information
    /// <summary>
    public partial class MT576_SequenceA
    {
        ...
        /// Linkages
        /// <summary>
		public List<MT576_SequenceA1> SequenceA1List { get; set; }
        /// <summary>
        /// Party
        /// <summary>
        ...
        public MT576_SequenceA()
        {
        }

        public MT576_SequenceA(SwiftTagList tags)
        {
            SetTags(tags);
        }
        ...
        public virtual void SetTags(SwiftTagList tags)
        {
            ...
            SequenceA1List = MT576_SequenceA1.GetMT576_SequenceA1List(tags);
        }

        public static MT576_SequenceA GetMT576_SequenceA(SwiftTagList tags)
        {
            SwiftTagList subBlock = tags.GetSubBlock(new SwiftTag("16R", MT576_SequenceA.Tag16R_StartOfBlock_Value), new SwiftTag("16S", MT576_SequenceA.Tag16S_EndOfBlock_Value));
            return new MT576_SequenceA(subBlock);
        }
    }
    ...
    /// Linkages
    /// <summary>
    public partial class MT576_SequenceA1
    {
        ...
        public MT576_SequenceA1()
        {
        }

        public MT576_SequenceA1(SwiftTagList tags)
        {
            SetTags(tags);
        }
        ...
        public static List<MT576_SequenceA1> GetMT576_SequenceA1List(SwiftTagList tags)
        {
            List<MT576_SequenceA1> result = new List<MT576_SequenceA1>();
            List<SwiftTagList> subBlocks = tags.GetSubBlocks(new SwiftTag("16R", MT576_SequenceA1.Tag16R_StartOfBlock_Value), new SwiftTag("16S", MT576_SequenceA1.Tag16S_EndOfBlock_Value));
            foreach (var subBlock in subBlocks)
            {
                var subTags = subBlock.GetSubBlock(new SwiftTag("16R", MT576_SequenceA1.Tag16R_StartOfBlock_Value), new SwiftTag("16S", MT576_SequenceA1.Tag16S_EndOfBlock_Value));
                if (subTags.Count == 0) continue;
                MT576_SequenceA1 sequence = new MT576_SequenceA1(subTags);
                result.Add(sequence);
            }
            return result;
        }
    ...
    /// Financial Instrument
    /// <summary>
    public partial class MT576_SequenceB
    {
        ...
        /// <summary>
		public List<MT576_SequenceB1> SequenceB1List { get; set; }
        /// <summary>
        /// Order Details
        /// <summary>
		public List<MT576_SequenceB2> SequenceB2List { get; set; }
        ...
        public MT576_SequenceB()
        {
        }

        public MT576_SequenceB(SwiftTagList tags)
        {
            SetTags(tags);
        }
        ...
        public virtual void SetTags(SwiftTagList tags)
        {
            ...
            SequenceB1List = MT576_SequenceB1.GetMT576_SequenceB1List(tags);
            SequenceB2List = MT576_SequenceB2.GetMT576_SequenceB2List(tags);
        }

        public static List<MT576_SequenceB> GetMT576_SequenceBList(SwiftTagList tags)
        {
            List<MT576_SequenceB> result = new List<MT576_SequenceB>();
            List<SwiftTagList> subBlocks = tags.GetSubBlocks(new SwiftTag("16R", MT576_SequenceB.Tag16R_StartOfBlock_Value), new SwiftTag("16S", MT576_SequenceB.Tag16S_EndOfBlock_Value));
            foreach (var subBlock in subBlocks)
            {
                var subTags = subBlock.GetSubBlock(new SwiftTag("16R", MT576_SequenceB.Tag16R_StartOfBlock_Value), new SwiftTag("16S", MT576_SequenceB.Tag16S_EndOfBlock_Value));
                if (subTags.Count == 0) continue;
                MT576_SequenceB sequence = new MT576_SequenceB(subTags);
                result.Add(sequence);
            }
            return result;
        }
    ...
    /// Financial Instrument Attributes
    /// <summary>
    public partial class MT576_SequenceB1
    {
        ...
        public MT576_SequenceB1()
        {
        }

        public MT576_SequenceB1(SwiftTagList tags)
        {
            SetTags(tags);
        }
        ...
        public static List<MT576_SequenceB1> GetMT576_SequenceB1List(SwiftTagList tags)
        {
            List<MT576_SequenceB1> result = new List<MT576_SequenceB1>();
            List<SwiftTagList> subBlocks = tags.GetSubBlocks(new SwiftTag("16R", MT576_SequenceB1.Tag16R_StartOfBlock_Value), new SwiftTag("16S", MT576_SequenceB1.Tag16S_EndOfBlock_Value));
            foreach (var subBlock in subBlocks)
            {
                var subTags = subBlock.GetSubBlock(new SwiftTag("16R", MT576_SequenceB1.Tag16R_StartOfBlock_Value), new SwiftTag("16S", MT576_SequenceB1.Tag16S_EndOfBlock_Value));
                if (subTags.Count == 0) continue;
                MT576_SequenceB1 sequence = new MT576_SequenceB1(subTags);
                result.Add(sequence);
            }
            return result;
        }
    ...
    /// Order Details
    /// <summary>
    public partial class MT576_SequenceB2
    {

        public static readonly string Tag16R_StartOfBlock_Value = "ORDER";
        /// <summary>
        /// Start Of Block
        /// <summary>
		public string Tag16R_StartOfBlock { get; set; }
        ...
        /// Date/Time of Order
        /// <summary>
		public string Tag98A_Date_1 { get; set; }
        /// <summary>
        /// Date/Time of Order
        /// <summary>
		public string Tag98C_DateTime_1 { get; set; }
        /// <summary>
        /// Quantity of Financial Instrument
        /// <summary>
		public List<string> Tag36B_QuantityOfFinancialInstrument { get; set; }
        ...
        /// Linkages
        /// <summary>
		public List<MT576_SequenceB2a> SequenceB2aList { get; set; }
        /// <summary>
        /// Price
        /// <summary>
		public List<MT576_SequenceB2b> SequenceB2bList { get; set; }
        /// <summary>
        /// Indicator
        /// <summary>
        ...
        /// Date/Time
        /// <summary>
		public List<string> Tag98A_Date_2 { get; set; }
        /// <summary>
        /// Date/Time
        /// <summary>
		public List<string> Tag98C_DateTime_2 { get; set; }
        /// <summary>
        /// Trading Parties
        /// <summary>
		public List<MT576_SequenceB2c> SequenceB2cList { get; set; }
        public static readonly string Tag16S_EndOfBlock_Value = "ORDER";
        /// <summary>
        /// End Of Block
        /// <summary>
		public string Tag16S_EndOfBlock { get; set; }

        public MT576_SequenceB2()
        {
        }

        public MT576_SequenceB2(SwiftTagList tags)
        {
            SetTags(tags);
        }
        ...
        public virtual SwiftTagList GetTags()
        {
            ...
            if (Tag16R_StartOfBlock != null)
                tags.Add(new SwiftTag("16R", Tag16R_StartOfBlock));
            if (Tag98A_Date_1 != null)
                tags.Add(new SwiftTag("98A", Tag98A_Date_1));
            if (Tag98C_DateTime_1 != null)
                tags.Add(new SwiftTag("98C", Tag98C_DateTime_1));
            if (Tag36B_QuantityOfFinancialInstrument != null)
                tags.AddRange(Tag36B_QuantityOfFinancialInstrument.Select(x => new SwiftTag("36B", x)).ToList());
            ...
            if (SequenceB2bList != null)
                tags.AddRange(SequenceB2bList.SelectMany(x => x.GetTags()).ToList());
            if (Tag22H_Indicator != null)
                tags.AddRange(Tag22H_Indicator.Select(x => new SwiftTag("22H", x)).ToList());
            if (Tag22F_Indicator != null)
                tags.AddRange(Tag22F_Indicator.Select(x => new SwiftTag("22F", x)).ToList());
            if (Tag98A_Date_2 != null)
                tags.AddRange(Tag98A_Date_2.Select(x => new SwiftTag("98A", x)).ToList());
            if (Tag98C_DateTime_2 != null)
                tags.AddRange(Tag98C_DateTime_2.Select(x => new SwiftTag("98C", x)).ToList());
            if (SequenceB2cList != null)
                tags.AddRange(SequenceB2cList.SelectMany(x => x.GetTags()).ToList());
            if (Tag16S_EndOfBlock != null)
                tags.Add(new SwiftTag("16S", Tag16S_EndOfBlock));
            return tags;
        }
        ...
        public virtual void SetTags(SwiftTagList tags)
        {
            ...
            foreach (SwiftTag tag in tags)
            {
                ...
                {
                    Tag98A_Date_1 = tag.Value;
                    i = 2;
                }
                else if ((tag.Name == "98C") && (i <= 2))
                {
                    Tag98C_DateTime_1 = tag.Value;
                    i = 2;
                }
                ...
                {
                    if (Tag98A_Date_2 == null)
                        Tag98A_Date_2 = new List<string>();
                    Tag98A_Date_2.Add(tag.Value);
                    i = 7;
                }
                else if ((tag.Name == "98C") && (i <= 7))
                {
                    if (Tag98C_DateTime_2 == null)
                        Tag98C_DateTime_2 = new List<string>();
                    Tag98C_DateTime_2.Add(tag.Value);
                    i = 7;
                }
            ...
            SequenceB2aList = MT576_SequenceB2a.GetMT576_SequenceB2aList(tags);
            SequenceB2bList = MT576_SequenceB2b.GetMT576_SequenceB2bList(tags);
            SequenceB2cList = MT576_SequenceB2c.GetMT576_SequenceB2cList(tags);
        }

        public static List<MT576_SequenceB2> GetMT576_SequenceB2List(SwiftTagList tags)
        {
            List<MT576_SequenceB2> result = new List<MT576_SequenceB2>();
            List<SwiftTagList> subBlocks = tags.GetSubBlocks(new SwiftTag("16R", MT576_SequenceB2.Tag16R_StartOfBlock_Value), new SwiftTag("16S", MT576_SequenceB2.Tag16S_EndOfBlock_Value));
            foreach (var subBlock in subBlocks)
            {
                var subTags = subBlock.GetSubBlock(new SwiftTag("16R", MT576_SequenceB2.Tag16R_StartOfBlock_Value), new SwiftTag("16S", MT576_SequenceB2.Tag16S_EndOfBlock_Value));
                if (subTags.Count == 0) continue;
                MT576_SequenceB2 sequence = new MT576_SequenceB2(subTags);
                result.Add(sequence);
            }
            return result;
        }
    ...
    /// Linkages
    /// <summary>
    public partial class MT576_SequenceB2a
    {
        ...
        public MT576_SequenceB2a()
        {
        }

        public MT576_SequenceB2a(SwiftTagList tags)
        {
            SetTags(tags);
        }
        ...
        public static List<MT576_SequenceB2a> GetMT576_SequenceB2aList(SwiftTagList tags)
        {
            List<MT576_SequenceB2a> result = new List<MT576_SequenceB2a>();
            List<SwiftTagList> subBlocks = tags.GetSubBlocks(new SwiftTag("16R", MT576_SequenceB2a.Tag16R_StartOfBlock_Value), new SwiftTag("16S", MT576_SequenceB2a.Tag16S_EndOfBlock_Value));
            foreach (var subBlock in subBlocks)
            {
                var subTags = subBlock.GetSubBlock(new SwiftTag("16R", MT576_SequenceB2a.Tag16R_StartOfBlock_Value), new SwiftTag("16S", MT576_SequenceB2a.Tag16S_EndOfBlock_Value));
                if (subTags.Count == 0) continue;
                MT576_SequenceB2a sequence = new MT576_SequenceB2a(subTags);
                result.Add(sequence);
            }
            return result;
        }
    ...
    /// Price
    /// <summary>
    public partial class MT576_SequenceB2b
    {
        ...
        public MT576_SequenceB2b()
        {
        }

        public MT576_SequenceB2b(SwiftTagList tags)
        {
            SetTags(tags);
        }
        ...
        public static List<MT576_SequenceB2b> GetMT576_SequenceB2bList(SwiftTagList tags)
        {
            List<MT576_SequenceB2b> result = new List<MT576_SequenceB2b>();
            List<SwiftTagList> subBlocks = tags.GetSubBlocks(new SwiftTag("16R", MT576_SequenceB2b.Tag16R_StartOfBlock_Value), new SwiftTag("16S", MT576_SequenceB2b.Tag16S_EndOfBlock_Value));
            foreach (var subBlock in subBlocks)
            {
                var subTags = subBlock.GetSubBlock(new SwiftTag("16R", MT576_SequenceB2b.Tag16R_StartOfBlock_Value), new SwiftTag("16S", MT576_SequenceB2b.Tag16S_EndOfBlock_Value));
                if (subTags.Count == 0) continue;
                MT576_SequenceB2b sequence = new MT576_SequenceB2b(subTags);
                result.Add(sequence);
            }
            return result;
        }
    ...
    /// Trading Parties
    /// <summary>
    public partial class MT576_SequenceB2c
    {
        ...
        public MT576_SequenceB2c()
        {
        }

        public MT576_SequenceB2c(SwiftTagList tags)
        {
            SetTags(tags);
        }
        ...
        public static List<MT576_SequenceB2c> GetMT576_SequenceB2cList(SwiftTagList tags)
        {
            List<MT576_SequenceB2c> result = new List<MT576_SequenceB2c>();
            List<SwiftTagList> subBlocks = tags.GetSubBlocks(new SwiftTag("16R", MT576_SequenceB2c.Tag16R_StartOfBlock_Value), new SwiftTag("16S", MT576_SequenceB2c.Tag16S_EndOfBlock_Value));
            foreach (var subBlock in subBlocks)
            {
                var subTags = subBlock.GetSubBlock(new SwiftTag("16R", MT576_SequenceB2c.Tag16R_StartOfBlock_Value), new SwiftTag("16S", MT576_SequenceB2c.Tag16S_EndOfBlock_Value));
                if (subTags.Count == 0) continue;
                MT576_SequenceB2c sequence = new MT576_SequenceB2c(subTags);
                result.Add(sequence);
            }
            return result;
        }
    ...
    /// Additional Information
    /// <summary>
    public partial class MT576_SequenceC
    {
        ...
        public MT576_SequenceC()
        {
        }

        public MT576_SequenceC(SwiftTagList tags)
        {
            SetTags(tags);
        }
        ...
        public static MT576_SequenceC GetMT576_SequenceC(SwiftTagList tags)
        {
            SwiftTagList subBlock = tags.GetSubBlock(new SwiftTag("16R", MT576_SequenceC.Tag16R_StartOfBlock_Value), new SwiftTag("16S", MT576_SequenceC.Tag16S_EndOfBlock_Value));
            return new MT576_SequenceC(subBlock);
        }
    }
}
